        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Downloads_ProductFiles_ProductFileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    OrderItemId = table.Column<Guid>(type: "uuid", nullable: false),
                    KeyString = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LicenseKeys_OrderItems_OrderItemId",
                        column: x => x.OrderItemId,
                        principalTable: "OrderItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subscriptions_OrderItems_OrderItemId",
                        column: x => x.OrderItemId,
                        principalTable: "OrderItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderItemAddonId = table.Column<Guid>(type: "uuid", nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceProjects_OrderItemAddons_OrderItemAddonId",
                        column: x => x.OrderItemAddonId,
                        principalTable: "OrderItemAddons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServiceProjects_OrderItems_OrderItemId",
                        column: x => x.OrderItemId,
                        principalTable: "OrderItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Downloads_ProductFileId",
                table: "Downloads",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LicenseKeys_KeyString",
                table: "LicenseKeys",
                column: "KeyString",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_LicenseKeys_OrderItemId",
                table: "LicenseKeys",
                column: "OrderItemId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceProjects_OrderItemAddonId",
                table: "ServiceProjects",
                column: "OrderItemAddonId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ServiceProjects_OrderItemId",
                table: "ServiceProjects",
                column: "OrderItemId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ServiceProjects_Status",
                table: "ServiceProjects",
                column: "Status");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subscriptions_OrderItemId",
                table: "Subscriptions",
                column: "OrderItemId",
                unique: true);
