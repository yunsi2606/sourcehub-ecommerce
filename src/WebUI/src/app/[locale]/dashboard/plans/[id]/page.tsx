...
export default function PlanEditPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const t = useTranslations("DashboardPlans");
  ...
  if (loading) return <div className="p-8 text-center text-slate-500 animate-pulse">{t("loading")}</div>;
    ...
    <div className="max-w-4xl mx-auto space-y-6 pb-24">
      ...
      <div className="flex items-center justify-between bg-white p-4 md:p-6 rounded-3xl border border-slate-200 shadow-sm sticky top-24 z-20">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-900">{isNew ? t("createPlan") : t("editPlan")}</h1>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm space-y-4">
          <h2 className="text-lg font-bold text-slate-900 mb-4 border-b border-slate-100 pb-2">{t("basicInfo")}</h2>
          ...
          <div>
            <label className="block text-sm font-bold text-slate-700 mb-1">{t("slug")}</label>
            <input
              type="text"
              value={formData.slug}
          ...
          <div>
            <label className="block text-sm font-bold text-slate-700 mb-1">{t("tierLevel")}</label>
            <input
              type="number"
              value={formData.tier}
        ...
        {/* Pricing & Stripe */}
        <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm space-y-4">
          <h2 className="text-lg font-bold text-slate-900 mb-4 border-b border-slate-100 pb-2">{t("pricing")}</h2>
          
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-bold text-slate-700 mb-1">{t("monthlyPrice")}</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-sm font-bold text-slate-700 mb-1">{t("yearlyPrice")}</label>
              <input
                type="number"
          ...
          <div className="pt-4">
            <label className="block text-sm font-bold text-slate-700 mb-1">{t("stripeMonthly")}</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-sm font-bold text-slate-700 mb-1">{t("stripeYearly")}</label>
            <input
              type="text"
        ...
        <div className="md:col-span-2 bg-white rounded-3xl p-6 border border-slate-200 shadow-sm space-y-4">
          <h2 className="text-lg font-bold text-slate-900 mb-4 border-b border-slate-100 pb-2">{t("features")}</h2>
          ...
          <div className="space-y-2 mt-4">
            ...
            {featuresList.length === 0 && (
              <p className="text-sm text-slate-500 text-center py-4">{t("noFeatures")}</p>
            )}
          </div>
        </div>
      </div>
