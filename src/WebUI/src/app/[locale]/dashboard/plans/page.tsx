    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12 bg-white border border-slate-200 rounded-3xl shadow-sm">
          ...
          <h3 className="text-lg font-bold text-slate-900 mb-1">{t("noPlans")}</h3>
          <p className="text-slate-500 text-sm mb-6">{t("noPlansDesc")}</p>
          <Link
            href="/dashboard/plans/new"
              ...
              <div className="p-6 flex-1">
                ...
                <div className="space-y-1 mb-6">
                  <div className="flex items-end gap-1">
                    ...
                    <span className="text-slate-500 font-medium mb-1">{t("monthly")}</span>
                  </div>
                  <div className="text-sm text-slate-500 font-medium">
                    {t("yearly", { price: formatPrice(plan.yearlyPrice) })}
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  {plan.features.length > 3 && (
                    <div className="text-xs font-medium text-slate-400 pl-6">
                      {t("moreFeatures", { count: plan.features.length - 3 })}
                    </div>
                  )}
                </div>
              </div>
